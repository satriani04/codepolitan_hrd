    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jenis_akun', models.CharField(choices=[('karyawan', 'Karyawan'), ('admin', 'Administrator')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jenis_karyawan', models.CharField(choices=[('magang', 'Magang'), ('kontrak', 'Kontrak'), ('tetap', 'Tetap')], max_length=20)),
                ('no_telepon', models.CharField(blank=True, max_length=100)),
